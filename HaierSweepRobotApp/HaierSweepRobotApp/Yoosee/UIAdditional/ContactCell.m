...
-(void)layoutSubviews{
    ...
    //bottomView的高
    CGFloat bottomView_h = 40;//70.0/SCREEN_SCALE;
    //topView高
    ...
    [playButton setBackgroundImage:LCImage(@"播放-") forState:UIControlStateNormal];
    playButton.frame = CGRectMake(ScreenWidth/2.0-20, 70, 40, 40);
    [playButton addTarget:self action:@selector(onHeadClick:) forControlEvents:UIControlEventTouchUpInside];
    ...
    CGFloat nameLabel_w2 = [Utils getStringWidthWithString:CustomLocalizedString(@"offline", nil) font:[UIFont systemFontOfSize:FondSizeWithPxValue(20)] maxWidth:width];
    //label的背景图片
    ...
    //在线、离线文本
    CGFloat stateLabel_w = [Utils getStringWidthWithString:CustomLocalizedString(@"offline", nil) font:[UIFont systemFontOfSize:FondSizeWithPxValue(20)] maxWidth:width];
    //label的背景图片
    ...
    if(!self.stateLabel){
        ...
        if (self.contact.isGettingOnLineState) {//isGettingOnLineState
            ...
            if(self.contact.onLineState==STATE_ONLINE){
                textLabel.text = CustomLocalizedString(@"online", nil);
            }else{
                textLabel.text = CustomLocalizedString(@"offline", nil);
            }
        }
        ...
        if (self.contact.isGettingOnLineState) {//isGettingOnLineState
            ...
            [stateImgView setHidden:NO];
            if(self.contact.onLineState==STATE_ONLINE){
                self.stateLabel.text = CustomLocalizedString(@"online", nil);
            }else{
                self.stateLabel.text = CustomLocalizedString(@"offline", nil);
            }
        }
    }
    ...
    if(!self.DeviceButton){
        ...
        self.DeviceButton = initDeviceButton;
    }else{
        self.DeviceButton.frame = CGRectMake(0.0 ,0.0 ,initDeviceButton_w,initDeviceButton_h);
    }
    ...
    if(isInitedDevice){
        [self.DeviceButton setHidden:NO];
        
    }else{
        [self.DeviceButton setHidden:YES];
    }
    ...
    if(!self.defenceStateView){
        ...
        defenceStateView.frame = CGRectMake(defenceStateView_x, 5, 30, 30);
        defenceStateView.layer.masksToBounds = YES;
        defenceStateView.layer.cornerRadius = 30/2.0;
        defenceStateView.backgroundColor = [JPColor jp_colorWithR:232 G:241 B:250 alpha:1.0];
        ...
        self.defenceStateView.frame = CGRectMake(defenceStateView_x, 5, 30, 30);
    ...
    if(!self.weakPwdButton){
        ...
        weakPwdButton.frame = CGRectMake(CGRectGetMaxX(self.defenceStateView.frame)+10.0 ,5 ,30,30);
        ...
        weakPwdButton.layer.masksToBounds = YES;
        weakPwdButton.layer.cornerRadius = 30/2.0;
        weakPwdButton.backgroundColor = [JPColor jp_colorWithR:232 G:241 B:250 alpha:1.0];
        ...
        UIImageView *weakPwdImageView = [[UIImageView alloc] initWithFrame:CGRectMake(7.5, 5, 15, 20)];
    ...
    if (!self.playbackButton) {
        ...
        playbackButton.frame = CGRectMake(CGRectGetMaxX(self.chatButton.frame)+10.0 ,5 ,30,30);
        ...
        playbackButton.layer.masksToBounds = YES;
        playbackButton.layer.cornerRadius = 30/2.0;
        playbackButton.backgroundColor = [JPColor jp_colorWithR:232 G:241 B:250 alpha:1.0];
        ...
        UIImageView *playbackImageView = [[UIImageView alloc] initWithFrame:CGRectMake(5, 5 ,20,20)];
    ...
    if (!self.controlButton) {
        ...
        controlButton.frame = CGRectMake(CGRectGetMaxX(self.playbackButton.frame)+10.0 ,5 ,30,30);
        ...
        controlButton.layer.cornerRadius = 30/2.0;
        controlButton.backgroundColor = [JPColor jp_colorWithR:232 G:241 B:250 alpha:1.0];
        ...
        UIImageView *controlImageView = [[UIImageView alloc] initWithFrame:CGRectMake(5, 5 ,20,20)];
    ...
    if (!self.modifyButton) {
        ...
        modifyButton.frame = CGRectMake(CGRectGetMaxX(self.controlButton.frame)+10.0 ,5 ,30,30);
        ...
        modifyButton.layer.cornerRadius = 30/2.0;
        modifyButton.backgroundColor = [JPColor jp_colorWithR:232 G:241 B:250 alpha:1.0];
        ...
        UIImageView *modifyImageView = [[UIImageView alloc] initWithFrame:CGRectMake(5, 5 ,20,20)];
    ...
    [self.contentView insertSubview:self.DeviceButton belowSubview:self.weakPwdButton];
}
...
-(void)reLayoutBtnViewInBottomByContactType{
    ...
    switch(self.contact.contactType){
        ...
        case CONTACT_TYPE_IPC:
        {
            ...
            self.modifyButton.frame = CGRectMake(modifyButton_x, 5 ,self.modifyButton.frame.size.width, self.modifyButton.frame.size.height);
            //设置按钮
            CGFloat controlButton_x = self.modifyButton.frame.origin.x-self.controlButton.frame.size.width-10.0;
            self.controlButton.frame = CGRectMake(controlButton_x, 5 ,self.controlButton.frame.size.width, self.controlButton.frame.size.height);
            ...
            self.playbackButton.frame = CGRectMake(playbackButton_x, 5 ,self.playbackButton.frame.size.width, self.playbackButton.frame.size.height);
            ...
            self.weakPwdButton.frame = CGRectMake(weakPwdButton_x+2.5, 5 ,self.weakPwdButton.frame.size.width, self.weakPwdButton.frame.size.height);
        ...
        case CONTACT_TYPE_NPC:
        {
            ...
            self.chatButton.frame = CGRectMake(chatButton_x, 5 ,self.chatButton.frame.size.width, self.chatButton.frame.size.height);
