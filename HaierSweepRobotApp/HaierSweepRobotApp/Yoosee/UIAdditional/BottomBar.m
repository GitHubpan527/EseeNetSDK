        ...
        for(int i=0;i<item_count;i++){
            ...
            switch(i){
                case 0:
                {
                    ...
                    itemTitle.text = CustomLocalizedString(@"device", nil);
                ...
                case 1:
                {
                    if ([[AppDelegate sharedDefault] dwApContactID] == 0) {
                        ...
                        itemTitle.text = CustomLocalizedString(@"message_item", nil);
                    ...
                    else
                    {
                        ...
                        itemTitle.text = CustomLocalizedString(@"screen_shot_item", nil);
                        itemTitle.textColor = [UIColor lightGrayColor];
                ...
                case 3:
                {
                    ...
                    itemTitle.text = CustomLocalizedString(@"more_item", nil);
                    itemTitle.textColor = [UIColor lightGrayColor];
                }
                    break;
//                case 4:
