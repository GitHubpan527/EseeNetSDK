...
- (id)initWithScrollView:(UIScrollView *)scrollView {
    ...
    titleLabel.text = CustomLocalizedString(@"Pull to refresh...",nil);
...
- (void)setLastUpdatedDate:(NSDate *)newLastUpdatedDate {
    self.dateLabel.text = [NSString stringWithFormat:CustomLocalizedString(@"Last Updated: %@",nil), newLastUpdatedDate?[self.dateFormatter stringFromDate:newLastUpdatedDate]:CustomLocalizedString(@"Never",nil)];
}
...
- (void)setState:(SVPullToRefreshState)newState {
    ...
    switch (newState) {
        ...
        case SVPullToRefreshStateTriggered:
            titleLabel.text = CustomLocalizedString(@"Release to refresh...",nil);
            [self rotateArrow:M_PI hide:NO];
            break;
            
        case SVPullToRefreshStateLoading:
            titleLabel.text = CustomLocalizedString(@"Loading...",nil);
