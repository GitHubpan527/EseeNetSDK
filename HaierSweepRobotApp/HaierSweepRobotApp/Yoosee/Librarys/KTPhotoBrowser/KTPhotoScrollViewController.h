...
#import "KTPhotoView.h"//保存图片到相册

@class KTPhotoViewController;
@protocol KTPhotoBrowserDataSource;

@interface KTPhotoScrollViewController : BaseViewController<UIScrollViewDelegate, UIActionSheetDelegate,KTPhotoViewDelegate>//保存图片到相册
{
