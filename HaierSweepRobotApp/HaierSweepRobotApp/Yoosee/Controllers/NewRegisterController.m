...
-(void)initComponent{
    ...
    [topBar setTitle:CustomLocalizedString(@"new_account_register",nil)];
    ...
    UISegmentedControl *segment = [[UISegmentedControl alloc] initWithItems:@[CustomLocalizedString(@"phone_register", nil),CustomLocalizedString(@"email_register", nil)]];
    ...
    field1.placeholder = CustomLocalizedString(@"input_phone", nil);
    ...
    [nextBtn setTitle:CustomLocalizedString(@"next", nil) forState:UIControlStateNormal];
    ...
    emailField1.placeholder = CustomLocalizedString(@"input_email", nil);
    ...
    emailField2.placeholder = CustomLocalizedString(@"input_password", nil);
    ...
    emailField3.placeholder = CustomLocalizedString(@"confirm_input", nil);
    ...
    [nextBtn2 setTitle:CustomLocalizedString(@"next", nil) forState:UIControlStateNormal];
...
-(void)onPhoneRegister{
    ...
    if(phone.length<6||phone.length>15){
        [self.view makeToast:CustomLocalizedString(@"phone_length_error", nil)];
        return;
    }
    ...
    if([self.countryCode isEqualToString:@"86"]){
        ...
        [[NetManager sharedManager] getPhoneCodeWithPhone:phone countryCode:self.countryCode callBack:^(id JSON) {
            ...
            switch(error_code){
                ...
                {
                    [self.view makeToast:CustomLocalizedString(@"phone_format_error", nil)];
                }
                    break;
