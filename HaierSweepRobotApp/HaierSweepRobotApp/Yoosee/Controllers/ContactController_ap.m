...
-(void)initComponent
{
    ...
    NSString* contactid = [NSString stringWithFormat:@"%d", [[AppDelegate sharedDefault] dwApContactID]];
    [_topBar setTitle:[NSString stringWithFormat:@"%@   %@", CustomLocalizedString(@"ap_mode_text", nil), contactid]];
    ...
    {
        CustomLocalizedString(@"ap_mode_btn_photoalbum", nil),
        CustomLocalizedString(@"ap_mode_btn_defence", nil),
        CustomLocalizedString(@"ap_mode_btn_playback", nil),
        CustomLocalizedString(@"ap_mode_btn_help", nil),
        CustomLocalizedString(@"ap_mode_btn_setting", nil)
    };
    ...
    switch (button.tag) {
        case ap_btn_tag_preview:
        {
            if ([self isWifiChanged]) {
                [self.view makeToast:CustomLocalizedString(@"ap_reconnect_tip", nil)];
            }
            else
            {
        ...
        {
            [self.view makeToast:CustomLocalizedString(@"ap_mode_quit", nil)];
        }
            break;
