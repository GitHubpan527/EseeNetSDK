...
-(void)initComponent{
    ...
    */
    ...
    UIBarButtonItem *firstItem = [UIBarButtonItem lc_itemWithIcon:@"添加-(1)" block:^{
        ...
        UIView *rightView = [[UIView alloc] initWithFrame:CGRectMake(ScreenWidth, 64, 0, 0)];
        [self.view addSubview:rightView];
        [popover showAtView:rightView withContentView:popoverView];
        
        [popoverView release];
    }];
    UIBarButtonItem *secondItem = [UIBarButtonItem lc_itemWithIcon:@"图册-" block:^{
...
//        label.text = CustomLocalizedString(@"no_init_password_device", nil);
//        return label;
//    }else{
//        return nil;
//    }
