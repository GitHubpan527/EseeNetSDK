...
@class CustomTopBar;
@interface P2PMonitorController : BaseViewController<AVCaptureVideoDataOutputSampleBufferDelegate,UIGestureRecognizerDelegate,TouchButtonDelegate,OpenGLViewDelegate,UIScrollViewDelegate,UIAlertViewDelegate,MainControllerDelegate,GApplicationDelegate,MainDelegate>//监控界面缩放
...
@property (nonatomic,strong)Contact *monitorContact;
