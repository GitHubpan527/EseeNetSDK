...
-(void)initComponent{
    ...
    [topBar setTitle:CustomLocalizedString(@"more_item",nil)];
    ...
    if([loginResult.contactId isEqual:@"0517400"]){
        curIDLabel.text = CustomLocalizedString(@"anonymous", nil);
    }else{
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (section) {
        case 0:
        {
            ...
            if([loginResult.contactId isEqual:@"0517400"]){
                if(row==0){
                    ...
                    [cell setLabelText:CustomLocalizedString(@"about_us", nil)];
                }
            }else{
                if(row==0){
                    ...
                    [cell setLabelText:CustomLocalizedString(@"account_info", nil)];
        ...
        case 1:
        {
            ...
            [cell setLabelText:CustomLocalizedString(@"logout", nil)];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch(section){
        ...
        case 1:
        {
            UIAlertView * alert = [[UIAlertView alloc] initWithTitle:CustomLocalizedString(@"logout_prompt", nil) message:nil delegate:self cancelButtonTitle:CustomLocalizedString(@"cancel", nil) otherButtonTitles:CustomLocalizedString(@"ok", nil), nil];
...
-(void)showAboutDialog{
    ...
    if(self.aboutView==nil){
        ...
        title.text = [NSString stringWithFormat:@"%@ %@",CustomLocalizedString(@"about", nil),APP_VERSION];
        ...
        label.text = CustomLocalizedString(@"about_text", nil);
