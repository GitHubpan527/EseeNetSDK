...
@class  Contact;
@interface P2PPlaybackController : BaseViewController<UITableViewDataSource,UITableViewDelegate,P2PPlaybackDelegate, CyclePickerViewDelegate,CyclePickerViewDatasource>
