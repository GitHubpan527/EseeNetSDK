...
- (void)initComponents
{
    ...
    //温馨提示
    CGFloat lableTip_w = [Utils getStringWidthWithString:CustomLocalizedString(@"add_guard_text07", nil) font:XFontBold_16 maxWidth:width-25*2];
    CGFloat lableTip_h = [Utils getStringHeightWithString:CustomLocalizedString(@"add_guard_text07", nil) font:XFontBold_16 maxWidth:width-25*2];
    UILabel* lableTip = [[UILabel alloc]initWithFrame:CGRectMake(25, imagView.frame.origin.y+imagView.frame.size.height+20, lableTip_w, lableTip_h)];
    [lableTip setText:CustomLocalizedString(@"add_guard_text07", nil)];
