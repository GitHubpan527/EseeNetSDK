...
-(void)initCompnents
{
    ...
    titleLable.text = CustomLocalizedString(@"connection_failure", nil);
    ...
    waitingContentLabel.text = CustomLocalizedString(@"failure_reason", nil);
    ...
    [bottomButton1 setTitle:CustomLocalizedString(@"try_again", nil) forState:UIControlStateNormal];
    ...
    [qrButton setTitle:CustomLocalizedString(@"add_by_qrcode", nil) forState:UIControlStateNormal];
