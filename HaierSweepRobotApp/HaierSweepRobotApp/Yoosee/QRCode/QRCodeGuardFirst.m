...
- (void)initComponents
{
    ...
    [lableTitle setText:CustomLocalizedString(@"add_guard_text00", nil)];
    lableTitle.backgroundColor = [UIColor clearColor];
    [self addSubview:lableTitle];
    [lableTitle release];
    
    
    NSArray* arrayText = [[NSArray alloc]initWithObjects:CustomLocalizedString(@"add_guard_text01", nil), CustomLocalizedString(@"add_guard_text02", nil), CustomLocalizedString(@"add_guard_text03", nil), nil];
    ...
    //温馨提示
    NSString*sTip = CustomLocalizedString(@"add_guard_text04", nil);
    ...
    [btnTip setTitle:CustomLocalizedString(@"add_guard_text05", nil) forState:UIControlStateNormal];
