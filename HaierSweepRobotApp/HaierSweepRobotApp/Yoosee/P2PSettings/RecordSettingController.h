...
@interface RecordSettingController : BaseViewController<UITableViewDataSource,UITableViewDelegate,P2PRecordTimeCellDelegate,SwitchCellDelegate, RecodeTypeDelegate>
