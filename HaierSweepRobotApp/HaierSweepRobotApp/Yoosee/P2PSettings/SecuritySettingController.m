...
-(void)initComponent{
    ...
    self.navigationItem.title = CustomLocalizedString(@"security_set",nil);
    ...
    switch (section) {
        case 0:
        {
            if(row==0){
                ...
                [emailCell setLeftLabelText:CustomLocalizedString(@"modify_manager_password", nil)];
            }
        ...
        case 1:
        {
            if(row==0){
                ...
                backImg_p = [UIImage imageNamed:@"bg_bar_btn_single_p.png"];
                [emailCell setRightIcon:@"ic_arrow.png"];
                [emailCell setLeftLabelText:CustomLocalizedString(@"modify_visitor_password", nil)];
                [emailCell setLeftIconHidden:YES];
                [emailCell setLeftLabelHidden:NO];
                [emailCell setRightLabelHidden:YES];
        ...
        case 2:
        {
            if(row==0){
                ...
                [cell2 setLeftLabelText:CustomLocalizedString(@"auto_update", nil)];
