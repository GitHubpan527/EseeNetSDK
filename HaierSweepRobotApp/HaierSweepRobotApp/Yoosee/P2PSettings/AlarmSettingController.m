...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (section == _dwAlarmAcceptRow) {
        ...
        [cell2 setLeftLabelText:CustomLocalizedString(@"accept_alarm", nil)];
        cell2.delegate = self;
    ...
    else if(section == _dwAlarmPushAccountRow)
    {
        ...
        [emailCell setLeftLabelText:CustomLocalizedString(@"alarm_push", nil)];
    }
    else if(section == _dwAlarmEmailRow)
    {
        backImg = [UIImage imageNamed:@"bg_bar_btn_single.png"];
        ...
        if(self.isLoadingBindEmail){
            ...
            if(self.bindEmail&&self.bindEmail.length>0){
                ...
                [emailCell setRightLabelText:CustomLocalizedString(@"unbind", nil)];
            }
        }
        [emailCell setLeftLabelText:CustomLocalizedString(@"alarm_email", nil)];
    }
    else if(section == _dwMotionRow)
    {
        backImg = [UIImage imageNamed:@"bg_bar_btn_single.png"];
        ...
        P2PSwitchCell *cell2 = (P2PSwitchCell*)cell;
        [cell2 setLeftLabelText:CustomLocalizedString(@"motion", nil)];
        cell2.delegate = self;
        cell2.indexPath = indexPath;
    ...
    else if(section == _dwBuzzerRow)
    {
        if(row==0){
            ...
            P2PSwitchCell *cell2 = (P2PSwitchCell*)cell;
            [cell2 setLeftLabelText:CustomLocalizedString(@"buzzer", nil)];
            cell2.delegate = self;
            cell2.indexPath = indexPath;
            ...
            [buzzerCell setLeftLabelText:CustomLocalizedString(@"buzzer_time", nil)];
    ...
    else if (section == _dwHumanInfraredRow)
    {
        ...
        P2PSwitchCell *cell2 = (P2PSwitchCell*)cell;
        [cell2 setLeftLabelText:CustomLocalizedString(@"human_infrared", nil)];
        cell2.delegate = self;
        cell2.indexPath = indexPath;
    ...
    else if (section == _dwWiredAlarmInputRow)
    {
        ...
        P2PSwitchCell *cell2 = (P2PSwitchCell*)cell;
        [cell2 setLeftLabelText:CustomLocalizedString(@"wired_alarm_input", nil)];
        cell2.delegate = self;
        cell2.indexPath = indexPath;
    ...
    else if (section == _dwWiredAlarmOutputRow)
    {
        ...
        P2PSwitchCell *cell2 = (P2PSwitchCell*)cell;
        [cell2 setLeftLabelText:CustomLocalizedString(@"wired_alarm_output", nil)];
        cell2.delegate = self;
        cell2.indexPath = indexPath;
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(indexPath.section==_dwAlarmPushAccountRow){
        ...
        if (self.bindIds.count > 0) {//无报警推送账号
            ...
            [self.view makeToast:CustomLocalizedString(@"no_alarm_push_id", nil)];
        }
    ...
    if (indexPath.section == _dwAlarmAcceptRow) {
        if (self.bindIds.count<self.maxBindIdCount) {
            ...
            if(self.alarmState==SETTING_VALUE_ALARM_STATE_OFF&&sender.on){
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    [self.tableView reloadData];
                    [self.view makeToast:[NSString stringWithFormat:@"%@ %i %@",CustomLocalizedString(@"add_bind_account_prompt1", nil),self.maxBindIdCount,CustomLocalizedString(@"add_bind_account_prompt2", nil)]];
                });
