...
-(void)showManualViewWithInitialization:(BOOL)isInitializing{
    ...
    if (isEmailVerified == 1) {//提示邮箱未验证
        ...
        self.m_pwdPromptLabelText = CustomLocalizedString(@"not_verified", nil);
    }else if (isEmailVerified == 0 && isRightPwd == 0) {//提示密码不匹配
        self.m_isHiddenPwdPromptLabel = NO;
        self.m_pwdPromptLabelText = CustomLocalizedString(@"pwd_smtp_error", nil);
    }else{
        self.m_isHiddenPwdPromptLabel = YES;
        self.m_pwdPromptLabelText = @"";
    }
...
-(void)showDefaultViewWithInitialization:(BOOL)isInitializing{
    ...
    if(bindEmail && bindEmail.length>0){
        ...
        if (smtpUser && smtpUser.length > 0) {
            //4. 提示栏
            if (isEmailVerified == 1) {//提示邮箱未验证
                self.pwdPromptLabel.text = CustomLocalizedString(@"not_verified", nil);
                
                //隐藏、显示pwdPromptLabel或解除绑定按钮，相关view位置的调整
                [self hiddenPwdPromptLabel:NO unbindButton:NO pwdPromptLabelText:CustomLocalizedString(@"not_verified", nil)];
            }else if (isEmailVerified == 0 && isRightPwd == 0) {//提示密码不匹配
                self.pwdPromptLabel.text = CustomLocalizedString(@"pwd_error", nil);
                
                //隐藏、显示pwdPromptLabel或解除绑定按钮，相关view位置的调整
                [self hiddenPwdPromptLabel:NO unbindButton:NO pwdPromptLabelText:CustomLocalizedString(@"pwd_error", nil)];
            }else{
                //隐藏、显示pwdPromptLabel或解除绑定按钮，相关view位置的调整
        ...
        case RET_GET_ALARM_EMAIL:
        {
            ...
            if (isEmailVerified == 1) {
                if (_getCounts < 5) {
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        [self.maskLayerView setHidden:YES];
                        [self.view makeToast:CustomLocalizedString(@"not_verified", nil)];
                        self.pwdPromptLabel.text = CustomLocalizedString(@"not_verified", nil);
                        if (_isManual) {
                            //隐藏、显示m_encryptView、pwdPromptLabel或解除绑定按钮，相关view位置的调整
                            self.m_isHiddenPwdPromptLabel = NO;
                ...
                if (isRightPwd == 0) {//错误，则在当前界面提示密码错误
                    ...
                    dispatch_async(dispatch_get_main_queue(), ^{
                        ...
                        if (_isManual) {
                            [self.view makeToast:CustomLocalizedString(@"pwd_smtp_error", nil)];
                            ...
                            [self.view makeToast:CustomLocalizedString(@"pwd_error", nil)];
                            self.pwdPromptLabel.text = CustomLocalizedString(@"pwd_error", nil);
...
- (void)viewDidLoad
{
    ...
    self.m_portArray = @[CustomLocalizedString(@"non_encrypted", nil),CustomLocalizedString(@"465(SSL)", nil),CustomLocalizedString(@"587(TLS)", nil),CustomLocalizedString(@"custom", nil)];
    [self initComponent];
}
...
-(void)initComponent{
    ...
    self.navigationItem.title = CustomLocalizedString(@"bind_email",nil);
...
-(void)initComponentOfSystemDefaultEmail:(CGFloat)width height:(CGFloat)height{
    ...
    field1.placeholder = CustomLocalizedString(@"input_email", nil);
    ...
    [unbindButton setTitle:CustomLocalizedString(@"unbind_email", nil) forState:UIControlStateNormal];
...
-(void)initComponentDefault:(CGFloat)width height:(CGFloat)height{
    ...
    senderTextField.placeholder = CustomLocalizedString(@"input_email", nil);
    ...
    //左边的view
    CGFloat senderLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"mailbox", nil) font:XFontBold_16 maxWidth:width];
    ...
    senderLeftLabel.text = CustomLocalizedString(@"mailbox", nil);
    ...
    pwdTextField.placeholder = CustomLocalizedString(@"input_password", nil);
    ...
    //左边的view
    CGFloat pwdLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"password", nil) font:XFontBold_16 maxWidth:width];
    ...
    pwdLeftLabel.text = CustomLocalizedString(@"password", nil);
    ...
    CGFloat manualLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"manual_setting", nil) font:XFontBold_16 maxWidth:width];
    ...
    manualLabel.text = CustomLocalizedString(@"manual_setting", nil);
...
-(void)initComponentManual:(CGFloat)width height:(CGFloat)height{
    ...
    m_receiverTextField.placeholder = CustomLocalizedString(@"recipient_number", nil);
    ...
    //左边的view
    CGFloat m_receiverLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"recipient", nil) font:XFontBold_16 maxWidth:width];
    ...
    m_receiverLeftLabel.text = CustomLocalizedString(@"recipient", nil);
    ...
    m_senderTextField.placeholder = CustomLocalizedString(@"input_sender", nil);
    ...
    //左边的view
    CGFloat m_senderLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"sender", nil) font:XFontBold_16 maxWidth:width];
    ...
    m_senderLeftLabel.text = CustomLocalizedString(@"sender", nil);
    ...
    m_smtpTextField.placeholder = CustomLocalizedString(@"smtp_number", nil);
    ...
    //左边的view
    CGFloat m_smtpLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"smtp_address", nil) font:XFontBold_16 maxWidth:width];
    ...
    m_smtpLeftLabel.text = CustomLocalizedString(@"smtp_address", nil);
    ...
    m_portTextField.placeholder = CustomLocalizedString(@"input_port", nil);
    ...
    //左边的view
    CGFloat m_portLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"port", nil) font:XFontBold_16 maxWidth:width];
    ...
    m_portLeftLabel.text = CustomLocalizedString(@"port", nil);
    ...
    m_pwdTextField.placeholder = CustomLocalizedString(@"input_password", nil);
    ...
    //左边的view
    CGFloat m_pwdLeftLabelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"password", nil) font:XFontBold_16 maxWidth:width];
    ...
    m_pwdLeftLabel.text = CustomLocalizedString(@"password", nil);
    ...
    //加密label
    CGFloat m_labelWidth = [Utils getStringWidthWithString:CustomLocalizedString(@"encryption_mode", nil) font:XFontBold_16 maxWidth:width];
    CGFloat m_labelHeight = [Utils getStringHeightWithString:CustomLocalizedString(@"encryption_mode", nil) font:XFontBold_16 maxWidth:width];
    UILabel *m_label = [[UILabel alloc] initWithFrame:CGRectMake(MARGIN_LEFT_RIGHT, 10.0, m_labelWidth, m_labelHeight)];
    m_label.backgroundColor = [UIColor clearColor];
    m_label.text = CustomLocalizedString(@"encryption_mode", nil);
    ...
    NSArray *m_encryptTextArr = @[CustomLocalizedString(@"one_encryption", nil),CustomLocalizedString(@"SSL", nil),CustomLocalizedString(@"TLS", nil)];
    for (int i=0; i<3; i++) {
    ...
    [m_unbindButton setTitle:CustomLocalizedString(@"unbind_email", nil) forState:UIControlStateNormal];
...
-(void)hiddenPwdPromptLabel:(BOOL)isHiddenPwdPromptLabel unbindButton:(BOOL)isHiddenUnbindButton pwdPromptLabelText:(NSString *)pwdPromptLabelText{
    ...
    if (isHiddenPwdPromptLabel && isHiddenUnbindButton) {
        ...
        // ljp [self.pwdPromptLabel setHidden:NO];
        [self.unbindButton setHidden:YES];
        //调整pwdPromptLabel的位置
...
-(void)bindedDefaultSystemEmail{
    ...
    if(!reciEmail||!reciEmail.length>0){
        [self.view makeToast:CustomLocalizedString(@"input_email", nil)];
        return;
    }
    ...
    if(reciEmail.length<5||reciEmail.length>31){
        [self.view makeToast:CustomLocalizedString(@"email_length_error", nil)];
        return;
    }
...
-(void)bindedNonSystemEmailInDefaultView{
    ...
    if (isIvalidEmail) {
        NSString *errorString = [NSString stringWithFormat:@"%@%@",CustomLocalizedString(@"not_support", nil),self.smtpTextField.text];
...
-(void)bindedNonSystemEmailInManualView{
    ...
    if(!reciEmail||reciEmail.length<=0){
        [self.view makeToast:CustomLocalizedString(@"recipient_not_empty", nil)];
        return;
    }
    //去掉reciEmail所有空格
    ...
    if (subEmails.count > 3) {
        [self.view makeToast:CustomLocalizedString(@"recipient_scope", nil)];
        return;
    }
    for (int i=0; i<subEmails.count; i++) {
        ...
        if(email.length<5||email.length>31){
            [self.view makeToast:CustomLocalizedString(@"recipient_length_format", nil)];
            return;
        }
        ...
        if(![emailFormat evaluateWithObject:email]){
            [self.view makeToast:CustomLocalizedString(@"recipient_format", nil)];
            return;
        }
    }
    ...
    if(!senderEmail||senderEmail.length<=0){
        [self.view makeToast:CustomLocalizedString(@"sender_not_empty", nil)];
        return;
    }
    NSArray *subSenderEmails = [senderEmail componentsSeparatedByString:@","];
    if (subSenderEmails.count > 1) {
        [self.view makeToast:CustomLocalizedString(@"sender_scope", nil)];
        return;
    }
    //邮箱长度应为5~31
    if(senderEmail.length<5||senderEmail.length>31){
        [self.view makeToast:CustomLocalizedString(@"sender_length_format", nil)];
        return;
    }
    //邮箱格式错误
    NSString *emailRegex = @"[A-Z0-9a-z._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}";
    ...
    if(![emailFormat evaluateWithObject:senderEmail]){
        [self.view makeToast:CustomLocalizedString(@"sender_format", nil)];
        return;
    }
    ...
    if(!smtpServer||smtpServer.length<=0){
        [self.view makeToast:CustomLocalizedString(@"smtp_not_empty", nil)];
        return;
    }
    //SMTP服务器不可以<=3
    if(smtpServer.length<=3){
        [self.view makeToast:CustomLocalizedString(@"smtp_format", nil)];
        return;
    }
    //去掉smtpServer所有空格
...
//    }
    ...
    if (subSmtpServers.count > 5) {
        [self.view makeToast:CustomLocalizedString(@"smtp_scope", nil)];
        return;
    }
    ...
    if(!self.m_portTextField.text||self.m_portTextField.text.length<=0){
        [self.view makeToast:CustomLocalizedString(@"port_not_empty", nil)];
        return;
    }
    if (![self.m_portTextField.text isValidateNumber]) {
        [self.view makeToast:CustomLocalizedString(@"port_format", nil)];
        return;
    }
    int smtpPort = [self.m_portTextField.text intValue];
    if (!(smtpPort>=0 && smtpPort<=65535)) {
        [self.view makeToast:CustomLocalizedString(@"port_scope", nil)];
        return;
    }
...
-(void)onUnbindEmail{
    NSString *message = @"";
    if(self.alarmSettingController.isSMTP == 0){
        message = [NSString stringWithFormat:@"%@%@?",CustomLocalizedString(@"unbind_email", nil),self.alarmSettingController.bindEmail];
        
    }else{
        if (_isManual) {
            message = [NSString stringWithFormat:@"%@%@?",CustomLocalizedString(@"unbind_email", nil),self.m_receiverTextField.text];
            
        }else{
            NSString *senderEmail = [NSString stringWithFormat:@"%@%@",self.senderTextField.text,self.smtpTextField.text];//发件人
            message = [NSString stringWithFormat:@"%@%@?",CustomLocalizedString(@"unbind_email", nil),senderEmail];
        }
    }
    
    
    
    UIAlertView *unBindEmailAlert = [[UIAlertView alloc] initWithTitle:CustomLocalizedString(@"unbind_email", nil) message:message delegate:self cancelButtonTitle:CustomLocalizedString(@"cancel", nil) otherButtonTitles:CustomLocalizedString(@"ok", nil),nil];
