...
-(void)initComponent{
    ...
    self.navigationItem.title = CustomLocalizedString(@"alarm_push",nil);
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row>0) {
        UIAlertView *unBindAccountAlert = [[UIAlertView alloc] initWithTitle:CustomLocalizedString(@"sure_to_unbind_account", nil) message:@"" delegate:self cancelButtonTitle:CustomLocalizedString(@"cancel", nil) otherButtonTitles:CustomLocalizedString(@"ok", nil),nil];
