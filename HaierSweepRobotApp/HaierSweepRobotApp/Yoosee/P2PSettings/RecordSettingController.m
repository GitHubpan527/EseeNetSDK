...
-(void)initComponent{
    ...
    self.navigationItem.title = CustomLocalizedString(@"record_set",nil);

    
    
    
    //SD卡不存在文本提示
    UILabel *sdCardPrompt = [[UILabel alloc] initWithFrame:CGRectMake(30.0, 0, width-30.0, 30.0)];
    ...
    else if (section == _iStorageSection)
    {
        ...
        if (0==section)
        {
            ...
            if(row==0){
                ...
                [emailCell setLeftLabelText:CustomLocalizedString(@"record_type", nil)];
        ...
        if (1==section)
        {
            if(self.recordType==SETTING_VALUE_RECORD_ALARM){
                if(row==0){
                    ...
                    backImg = [UIImage imageNamed:@"bg_bar_btn_top.png"];
                    backImg_p = [UIImage imageNamed:@"bg_bar_btn_top_p.png"];
                    [emailCell setLeftLabelText:CustomLocalizedString(@"record_time", nil)];
                ...
                if(row==0){
                    ...
                    backImg = [UIImage imageNamed:@"bg_bar_btn_top.png"];
                    backImg_p = [UIImage imageNamed:@"bg_bar_btn_top_p.png"];
                    [emailCell setLeftLabelText:CustomLocalizedString(@"plan_time_table", nil)];
                    [emailCell setLeftIconHidden:YES];
                    [emailCell setLeftLabelHidden:NO];
                    [emailCell setRightIconHidden:YES];
                    [emailCell setRightLabelHidden:YES];
                    ...
                    [timeCell setLeftLabelText:CustomLocalizedString(@"apply", nil)];
                ...
                if(row==0){
                    ...
                    backImg = [UIImage imageNamed:@"bg_bar_btn_single.png"];
                    backImg_p = [UIImage imageNamed:@"bg_bar_btn_single_p.png"];
                    [switchCell setLeftLabelText:CustomLocalizedString(@"remote_record_switch", nil)];
        ...
        if (_iPreRecordSection==section)
        {
            ...
            backImg = [UIImage imageNamed:@"bg_bar_btn_single.png"];
            backImg_p = [UIImage imageNamed:@"bg_bar_btn_single_p.png"];
            [switchCell setLeftLabelText:CustomLocalizedString(@"early_record", nil)];
    ...
    if (_iStorageSection == section) {
        ...
        if (self.storageCount == 1)
        {
            ...
            else if (row==2)    //格式化
            {
                ...
                [cellx setLeftLabelText:CustomLocalizedString(@"sd_card_format", nil)];
            ...
            if(row==0){
                ...
                [cellx setLeftLabelText:CustomLocalizedString(@"sd_card_capacity", nil)];
                if(self.isLoadingStorageInfo){
                    [cellx setLeftLabelHidden:NO];
                    [cellx setRightLabelHidden:YES];
                    [cellx setProgressViewHidden:NO];
                ...
                [cellx setLeftLabelText:CustomLocalizedString(@"sd_card_rem_capacity", nil)];
                if(self.isLoadingStorageInfo){
                    [cellx setLeftLabelHidden:NO];
                    [cellx setRightLabelHidden:YES];
                    [cellx setProgressViewHidden:NO];
                ...
                [cellx setLeftLabelText:CustomLocalizedString(@"u_disk_capacity", nil)];
                if(self.isLoadingStorageInfo){
                    [cellx setLeftLabelHidden:NO];
                    [cellx setRightLabelHidden:YES];
                    [cellx setProgressViewHidden:NO];
                ...
                [cellx setLeftLabelText:CustomLocalizedString(@"u_disk_rem_capacity", nil)];
                if(self.isLoadingStorageInfo){
                    [cellx setLeftLabelHidden:NO];
                    [cellx setRightLabelHidden:YES];
                    [cellx setProgressViewHidden:NO];
