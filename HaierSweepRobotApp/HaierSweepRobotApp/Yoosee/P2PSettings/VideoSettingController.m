...
-(void)initComponent{
    ...
    self.navigationItem.title = CustomLocalizedString(@"media_set",nil);
    ...
    switch (section) {
        case 0:
        {
            ...
            if(row==0){
                ...
                [cell1 setLeftLabelText:CustomLocalizedString(@"video_format", nil)];
        ...
        case 1:
        {
            ...
            if(row==0){
                ...
                [cell2 setLeftLabelText:CustomLocalizedString(@"volume", nil)];
        ...
        case 2:
        {
            if(row==0){
                ...
                [cell2 setLeftLabelText:CustomLocalizedString(@"image_inversion", nil)];
                cell2.delegate = self;
