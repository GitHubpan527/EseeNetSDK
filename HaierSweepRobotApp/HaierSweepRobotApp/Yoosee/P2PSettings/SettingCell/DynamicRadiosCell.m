...
-(NSString *)deviceLanguageName:(NSNumber *)supportLanguage{
    ...
    switch(supportLanguage.intValue){
        case 0:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_english", nil);
        }
            break;
        case 1:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_simplified", nil);
        }
            break;
        case 2:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_japanese", nil);
        }
            break;
        case 3:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_portuguese", nil);
        }
            break;
        case 4:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_spanish", nil);
        }
            break;
        case 5:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_traditional", nil);
        }
            break;
        case 6:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_french", nil);
        }
            break;
        case 7:
        {
            deviceLanguageName = CustomLocalizedString(@"push_language_russian", nil);
        }
            break;
    }
