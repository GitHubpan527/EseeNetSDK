...
-(void)initComponent{
    ...
    self.navigationItem.title = CustomLocalizedString(@"remote_set",nil);
    ...
    switch (section) {
        case 0:
        {
            ...
            if(row==0){
                ...
                [switchCell setLeftLabelText:CustomLocalizedString(@"remote_defence", nil)];
                ...
                [switchCell setLeftLabelText:CustomLocalizedString(@"remote_record", nil)];
