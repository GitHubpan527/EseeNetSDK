    ...
    switch (section) {
        case 0:
        {
            ...
            if(row==0){
                ...
                [timeCell setLeftLabelText:CustomLocalizedString(@"time_set", nil)];
        ...
        case 1:
        {
            ...
            timezoneCell.timezone = self.timezone;
            ...
            if(row==0){
                ...
                [timezoneCell setLeftLabelText:CustomLocalizedString(@"time_zone_set", nil)];
                ...
                [timezoneCell setCustomViewHidden:YES];
                [timezoneCell setLeftLabelText:CustomLocalizedString(@"apply", nil)];
                //self.timezone表示设备返回的时区所在数组的下标
                //value表示该下标对应的时区值
                float value = fTimeZoneVal[timeZoneFlag[self.timezone]];
                if(value<0){
                    [timezoneCell setRightLabelText:[NSString stringWithFormat:@"UTC %g",value]];
