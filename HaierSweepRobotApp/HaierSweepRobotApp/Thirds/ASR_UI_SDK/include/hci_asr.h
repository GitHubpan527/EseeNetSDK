...
extern "C"
{
	...
	*				云端freetalk和dialog支持：pcm16k16bit，pcm8k16bit，ulaw16k8bit，ulaw8k8bit，alaw16k8bit，alaw8k8bit<br/></td>
	*		</tr>
    *		<tr>
    *			<td>encode</td>
    ...
    *			<td>yes</td>
    *			<td>识别前进行端点检测</td>
    *			<td>如果为yes则开启端点检测，如果no则不关闭端点检测</td>
    *		</tr> 
	*		<tr>
	*			<td>vadHead</td>
